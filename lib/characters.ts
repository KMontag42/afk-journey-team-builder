...
export const Characters: Character[] = [
  ...
  { name: "Brutus", faction: Faction.Mauler, class: CharacterClass.Tank },
  ...
  { name: "Chippy", faction: Faction.Lightbearer, class: CharacterClass.Mage },
  ...
  { name: "Hammie", faction: Faction.Lightbearer, class: CharacterClass.Mage },
  ...
  { name: "Soren", faction: Faction.Mauler, class: CharacterClass.Mage },
