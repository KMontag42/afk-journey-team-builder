...
export default async function FormationPage({
  ...
  const cmsData = await (await fetch(`https://simplejsoncms.com/api/${process.env.NEXT_PUBLIC_SIMPLEJSONCMS_ID}`)).json();
  ...
  return (
    <div className="container flex flex-col items-center mr-6 my-4">
